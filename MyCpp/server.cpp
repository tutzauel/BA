	...
	*/
	Paillier::Ciphertext Server::SecureComparison (const Paillier::Ciphertext &a, const Paillier::Ciphertext &b) const {
		...
		*/
		...
		//Ausgabe der Chiffrate	
		//std::cout << "e(x): "<< a.ToString(10)  << std::endl;
		//std::cout << "e(y): "<< b.ToString(10)  << std::endl;

		std::cout << "Server.cpp: SecureComparison (DGK) mit der [Distanz] und dem [Threshold] wird gestartet" << std::endl;		
