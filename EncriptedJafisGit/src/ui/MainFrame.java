		...
		matchButton.addMouseListener(new MouseAdapter() 
		{
			...
			public void mouseClicked(MouseEvent e) 
			{
				...
				if (loadedImagePath != null) 				
				{
					...
					//Bild vom ausgesuchten Pfad nehmen
					Fingerprint newFingerprint = Fingerprint.extractFeatures(loadedImagePath);					
					
					//Try Catch an dieser Stelle wegen den Streams welcher in derMethode match() benutzt werden
					try
					{				
						...
						System.out.println("Dauer des Vorgangs:" + elapsedtime);	
